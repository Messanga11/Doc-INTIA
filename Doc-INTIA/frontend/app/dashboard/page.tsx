...
import { clientsApi, policiesApi } from '@/lib/api'
...
export default function DashboardPage() {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const activePoliciesData = await policiesApi.getAll({ skip: 0, limit: 1, status: 'active' })
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Vue d'ensemble du système INTIA Assurance</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Les fonctionnalités d'activité récente seront disponibles prochainement.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Les statistiques détaillées par succursale seront disponibles prochainement.
            </p>
          </CardContent>
        </Card>
      </div>
